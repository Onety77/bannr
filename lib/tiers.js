...
// ══ HOLDER · BACKER · PATRON ══
//
// Was Holder / Insider / Founder, and two of those were wrong.
// "Insider" carries insider trading — something slightly shady and
// exclusionary, on a rung meant to feel good to reach. "Founder" is a
// claim about having built the thing, which nobody did by buying a
// token.
//
// These ascend by commitment instead of by rank, and the top one says
// something true about the relationship: a patron is the person who
// funds a studio's work, which is exactly what this is and exactly
// what the rung's own perk — a style made for them — describes.
//
// Names in a LIVE ladder are stored in Firestore and are not changed
// by editing this list. These are what a fresh install starts with.
export const DEFAULT_TIERS = [
  { id: "t1", name: "Holder", minTokens: 0, dailyRuns: 2, discount: 10, earlyAccess: false, customStyle: false },
  { id: "t2", name: "Backer", minTokens: 0, dailyRuns: 3, discount: 25, earlyAccess: true,  customStyle: false },
  { id: "t3", name: "Patron", minTokens: 0, dailyRuns: 5, discount: 40, earlyAccess: true,  customStyle: true  },
];
