...
export const TEMPLATES = [
  {
    id: "tech",
    name: "Tech",
    tagline: "Designed, not rendered.",
    accent: "#2451FF",
    thumb: "tech.jpg",
    mood: `This is a serious piece of technology, and the banner should look like the brand team behind one designed it. Work in the language of premium technology marketing design: confident typography treated as a primary compositional element, precise alignment and real grid discipline, generous negative space, and a restrained palette where one or two colours do all the work. Build with graphic form — clean geometry, considered gradients, crisp edges, purposeful rules, shapes and repetition — the kind of key art a great company puts behind a product launch.

THIS IS GRAPHIC DESIGN, NOT A RENDERED SCENE. Do not build an environment for the subject to stand in. No architecture, no buildings, no interiors, no offices, no laboratories, no cityscapes, no landscapes, no horizons, no desks, no devices, no screens, no hardware, no product mockups, no photoreal 3D sets, no depth-of-field photography. The subject belongs ON the canvas as a designed element, not photographed inside a location.

Avoid circuit boards, floating code, holographic interfaces, hexagon grids, binary text and decorative sci-fi entirely. Intelligence here is communicated through restraint and craft, not through props that signal "technology" — the composure of a company with nothing to prove.`,
