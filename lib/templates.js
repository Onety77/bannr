...
export const TEMPLATES = [
  {
    id: "tech",
    name: "Tech",
    tagline: "Engineered, not sci-fi.",
    accent: "#2451FF",
    thumb: "tech.jpg",
    mood: `This project represents technology, engineering, infrastructure, or innovation. Create a banner that feels intelligent, modern, and confidently engineered rather than futuristic for its own sake. Draw inspiration from premium technology brands, operating systems, industrial design, research labs, clean interfaces, architecture, data, precision, and elegant minimalism. Visual interest should come from composition, materials, depth, lighting, and refined details instead of generic "tech" clichés. Avoid circuit-board patterns, floating code, holographic UI overload, hexagon grids, binary text, or decorative sci-fi elements unless explicitly requested. The result should feel like a product built by exceptional engineers that people trust.`,
    layout: DEMO_LAYOUT,
