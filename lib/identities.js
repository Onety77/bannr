...
//
// MIGRATION NOTE, and the reason this was cheap: existing accounts
// KEEP their document id, which happens to be a wallet address. An
// address is a perfectly good opaque key. Nothing moved, no balance
// was ever in flight, and old session cookies still resolve — they
// carry what is now simply an account id that looks unusual. Only
// new accounts get generated ids.
// ============================================================
import "server-only";
