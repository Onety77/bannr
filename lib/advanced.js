  ...
  collectibles: [
    {
      ...
      options: [
        { v: "auto", label: "Default" },
        { v: "grid", label: "Grid", prompt: "Compose the set as an ordered arrangement of panels — a deliberate grid, designed as part of the artwork." },
    ...
    },
    {
      ...
      options: [
        ...
        { v: "handcut", label: "Hand-cut", prompt: "Give the panels loose, imperfect, hand-cut borders — lines that tilt, wobble and vary in thickness, panels sitting slightly askew, no two edges quite parallel, like a zine page or a sticker sheet cut out by hand with scissors. The imperfection must read as deliberate craft and charm, never as sloppiness: confident, playful, and clearly made by someone who could have drawn it straight and chose not to." },
      ],
    },
    {
      key: "variance",
