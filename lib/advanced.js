  ...
  pov: [
    {
      key: "shot",
      label: "Shot",
      help: "Where the camera stands. Default lets each option take a different one.",
      options: [
        { v: "auto", label: "Default" },
        { v: "behind", label: "From behind", prompt: "Place the camera behind the subject: we see its back, and it is facing away from us into the scene, looking at whatever it is looking at. Do not show its face. Turn the head only slightly, and only if that is what keeps it recognisable." },
        { v: "profile", label: "Profile", prompt: "Shoot the subject from the side. We see the full profile — the outline of the face or body edge-on against the ground behind it — not a three-quarter view and not the front." },
        { v: "low", label: "Low angle", prompt: "Put the camera low, near the ground, looking up at the subject so it rises above the viewer and stands against whatever is overhead." },
        { v: "high", label: "High angle", prompt: "Put the camera above the subject looking down, so the ground it stands on becomes part of the composition." },
        { v: "far", label: "Far away", prompt: "Place the camera a long way off. The subject is small in a wide frame and reads by silhouette and by sitting at the point of highest contrast — never so small that it has to be hunted for." },
        { v: "close", label: "Close on a detail", prompt: "Move the camera in until one characteristic part of the subject fills the frame — an eye, a hand, a paw, an edge, a texture — cropped hard by the frame, with the rest of the subject implied rather than shown." },
      ],
    },
    {
      key: "looking",
