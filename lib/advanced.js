...
export const PER_STYLE = {
  ...
  collectibles: [
    ...
    },
    {
      ...
      options: [
        { v: "auto", label: "Auto" },
        { v: "none", label: "None", prompt: "Use no dividers or borders at all — let the variations sit on a shared ground, separated only by spacing." },
        { v: "thin", label: "Thin lines", prompt: "Separate the panels with fine, precise dividing lines." },
        { v: "thick", label: "Thick borders", prompt: "Give each panel a heavy, confident border, like a printed sticker sheet." },
        { v: "rounded", label: "Rounded cards", prompt: "Present each variation on its own rounded card with clear separation, like a set of trading cards laid out." },
      ],
    },
    {
      key: "variance",
  ...
  tech: [
    {
      ...
      options: [
        { v: "auto", label: "Auto" },
        { v: "glass", label: "Glass", prompt: "Build the scene from glass and transparency — refraction, edge highlights, layered depth." },
        { v: "concrete", label: "Concrete", prompt: "Build the scene from concrete and raw architectural material — matte surfaces, honest weight, brutalist calm." },
        { v: "metal", label: "Metal", prompt: "Build the scene from machined metal — precise edges, brushed and polished surfaces, industrial precision." },
        { v: "paper", label: "Paper", prompt: "Build the scene from paper and print — clean stock, subtle fold and shadow, editorial restraint." },
        { v: "screen", label: "Displays", prompt: "Build the scene around real screens and displays — believable interface light, honest device hardware, no invented holographic UI." },
      ],
    },
  ],
};
