...
export const UNIVERSAL = [
  {
    ...
    label: "Text",
    structural: true,
    help: "Overrides the style's own default.",
    options: [
  ...
  },
  {
    ...
    label: "Ticker",
    structural: true,
    help: "Auto hides it when it just restates the name.",
    options: [
      { v: "auto", label: "Default" },
...
export const PER_STYLE = {
  ...
  pov: [
    ...
    },
    {
      key: "looking",
      label: "What it faces",
      help: "For shots where the subject is turned away.",
      options: [
        { v: "auto", label: "Default" },
