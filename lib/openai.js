...
- THE GROUND IS ONE THING AND IT IS QUIET. Name it in every concept and name something plain: a flat colour, one honest material, a single photograph, a printed surface, a geometric system. The idea lives in what sits ON that ground and in how much room is left around it. Never build a scene, and never a modelled object in a lit room — a glass prism on a reflective floor, a metal form under studio lights, a sculpture on a plinth. That is a product render, not a designed banner. The strongest work here is almost empty.
