...
- Each concept: 50–90 words, concrete enough to execute. Name the genre, the shot, the light, the setting, and where the name sits.`,
  ...
  him: {
    ...
    palette: `- THE SUBJECT IS ATTACHED. LOOK AT IT BEFORE YOU DECIDE ANYTHING. Not the name — the image. What is its posture, where is it already looking, is it heavy or slight, smooth or matted, warm or cold, drawn or rendered or photographed? A name tells you the noun and nothing about the bearing, and the bearing is the entire job here. Name in each concept the specific thing you saw that the staging answers to.
