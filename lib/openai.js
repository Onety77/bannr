...
- SAY WHAT THE MARK IS DOING, in every concept. Placed small against a large field. Repeated as a pattern or system. Cropped hard by an edge. Used as the counter of a letterform. Standing as the only object on a plain ground. Left out of the frame entirely because the name carries it. That decision is yours now that you can see the thing, and it is what stops the mark being pasted into a corner at the end.
