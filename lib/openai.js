...
- NO GLOSSY PRODUCT SHOT. Do not propose a chrome, glass, liquid-metal or plastic object floating on a gradient under studio lighting — no hovering 3D logo, no beveled coin, no device mockup on a pedestal, no glass card catching a highlight. It is the default look this kind of brief attracts, it is what a template generator produces, and it reads as expensive to nobody. Depth, photography and real materials are welcome when the project genuinely points at them and they are honestly lit: a real object photographed on a real surface is not the same thing as a rendered showpiece hanging in the void. If your concept would work as a phone-case advert, it is the wrong concept.
