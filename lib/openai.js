...
- EACH CONCEPT LEADS WITH A DIFFERENT LEVER. Presence comes from a small set of tools and the ${"COUNT"} options must not all reach for the same one. The levers: enormous scale, the subject cropped by the frame so it cannot be contained; extreme negative space, the subject small in a vast field and still commanding it; camera position, low and looking up; light alone, one hard source in near-darkness; atmosphere, fog or haze or dust doing the work; proximity, close enough to read the material it is made of.
...
- THE SUBJECT STAYS ITSELF — proportions, colours, features and character preserved exactly. You are staging it, not redesigning it.
...
- Each concept: 50–90 words. Name the quality of presence, the lever, the light, the camera, the ground.`,
  },
