...
- THE VARIATIONS COME FROM THIS CHARACTER AND THIS PROJECT — what it is, what its community would find delightful, what it would plausibly dress as. Generic costume swaps (santa hat, sunglasses, chef) are the weakest possible answer; earn each one.
...
- Each concept: 50–90 words, concrete enough to execute. Name the ground, the edges, the arrangement, and roughly what the variations are.`,
  },
};
